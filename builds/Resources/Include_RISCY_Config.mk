...
ifeq (,$(filter $(DATA_PREFETCHER_TYPE),MARKOV MARKOV_ON_HIT MARKOV_ON_HIT_2 BLOCK STRIDE STRIDE_ADAPTIVE CDP CDP_LLC CDP_MULTIISSUE CDP_PATHHIST CDP_PATHHIST_XOR CDP_ADAPTIVE CDP_PROBTT CDP_KILLSWITCH CDP_ATTRIB CDP_HYBRID CDP_HYBRID2 CDP_NAIVE))
